...
const { userInfo } = AuthHooks();
  ...
  const showAdddeprandum = () => setShow(true);
  const [deps, setDeps] = useState([]);
  const [dep, setDep] = useState([]);

  const closeAdddeprandum = () => {
    getDEP();
    setShow(false);
  };
      ...
      return (
        <React.Fragment>
              <div className="columns mt-6">
                ...
                {/* <ModalAdddeprandum show={show} onHide={closeAdddeprandum}>
                  Ajout Nouveau deprandum
                </ModalAdddeprandum> */}
                <Navbar />
                      ...
                      <h2>
                        <div className="column is-2">
                          ...
                          {/* <Button
                            ...
                            variant="primary"
                            onClick={showAdddeprandum()}
                          >
                            <IoDocumentTextSharp /> Nouveau deprandum
                          </Button> */}
                          Liste des deprandums
                          <span> </span> <span> </span>
                        <label>
                        </label>
                      </h2>
              ...
              <div>
                ...
                <div className="table-responsive text-nowrap"style={{ 
                  ...
                  <table className='table is-striped is-fullwidth' >
                    <thead>
                      <tr>
                        <th scope="col">Numero deprandum</th>
